...
print(all.equal(neum_Linux, reg_Linux, tolerance=1.0e-13))
cat(paste("\n\nCompare Neumaier Windows with regular Windows:\n"))
print(all.equal(neum_Windows, reg_Windows, tolerance=1.0e-13))
cat(paste("\n\nCompare Neumaier macOS with regular macOS:\n"))
print(all.equal(neum_macOS, reg_macOS, tolerance=1.0e-13))