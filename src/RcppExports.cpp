...
// phicpp
SEXP phicpp(SEXP eta, SEXP beta, SEXP doc_ct);
RcppExport SEXP stm_phicpp(SEXP etaSEXP, SEXP betaSEXP, SEXP doc_ctSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type eta(etaSEXP);
    Rcpp::traits::input_parameter< SEXP >::type beta(betaSEXP);
    Rcpp::traits::input_parameter< SEXP >::type doc_ct(doc_ctSEXP);
    rcpp_result_gen = Rcpp::wrap(phicpp(eta, beta, doc_ct));
    return rcpp_result_gen;
END_RCPP
}
