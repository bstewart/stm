...
stm:::plot.STM(poliblogPrevFit, type = "summary", xlim = c(0, .3))
@
...
stm:::plot.STM(poliblogContent, type = "perspectives", topics = 11)
@
...
\begin{center}
<<eval=TRUE,fig=TRUE,width=6,height=4,keep.source=TRUE, results = verbatim>>=
stm:::plot.STM(poliblogPrevFit, type = "perspectives", topics = c(12, 20))
@
