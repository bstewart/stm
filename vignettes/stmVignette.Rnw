...
<<eval=FALSE>>=
selectedmodel <- poliblogSelect$runout[[3]] #choose the third model
@
...
plot.estimateEffect(prep, covariate = "rating", topics = c(3, 7, 20),
        ...
        custom.labels = c('Obama', 'Sarah Palin',
                          'Bush Presidency'))
@
